...
def main():
    ...
    model = ConcatFusionModel(num_classes=train_ds.num_classes).to(device)
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        print(f"[CONCAT FUSION] Epoch {epoch}/{EPOCHS} | "
        ...
        if test_acc > best_acc:
            best_acc = test_acc
            torch.save(model.state_dict(), "outputs/concat_fusion_model.pth")

    print("🔥 Best CONCAT Accuracy:", best_acc)
