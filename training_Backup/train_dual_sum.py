...
from models.dual_sum import SumFusionModel   # 🔥 UPDATED IMPORT
...
def main():
    ...
    model = SumFusionModel(num_classes=train_ds.num_classes).to(device)
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        print(f"[SUM FUSION] Epoch {epoch}/{EPOCHS} | "
        ...
        if test_acc > best_acc:
            best_acc = test_acc
            torch.save(model.state_dict(), "outputs/sum_fusion_model.pth")

    print("🔥 Best SUM Accuracy:", best_acc)
